      ...
      <ul className="absolute bg-zinc-200 w-full px-8 gap-4">
        ...
        <div className=" flex flex-col gap-4 mb-5">
          <Link to="/login">
            <NavButton
              title="Login"
              className="bg-transparent text-indigo-600 px-8 py-3 w-full rounded-md font-bold hover:duration-500 hover:bg-[#fff] hover:text-[#317773] border-2 border-[#317773]"
            />
          </Link>
