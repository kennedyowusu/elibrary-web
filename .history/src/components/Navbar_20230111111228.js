      ...
      <ul className="absolute bg-zinc-200 w-full px-8 gap-4">
        ...
        <div className=" flex flex-col gap-5 mb-5">
          <Link to="/login">
            <NavButton
              title="Login"
              className="bg-transparent border-2 px-6 w-full py-2 rounded-md mt-[-6px] font-bold hover:duration-500 hover:bg-[#317773] text-[#317773] hover:text-white"
            />
          </Link>
          ...
          <Link to="register">
            <NavButton
              title="Register"
              className="bg-[#317773] text-white px-8 py-2 w-full rounded-md font-bold hover:duration-500 hover:bg-[#fff] hover:text-[#317773] border-2 border-[#317773]"
            />
          </Link>
        </div>
      </ul>
