        ...
        <div className="flex items-center justify-end w-full">
          <ul className="flex gap-4">
            {navLink.map((link) => (
             ...
             "
              >
                <a
                  href={link ? link.link : '/'}
                  className="text-gray-800 font-medium text-lg hover:border-solid border-2 p-8 rounded-lg
            ...
            <Link to="register">
              <NavButton
                title="Register"
                className="bg-[#317773] text-white px-6 py-2 rounded-md mt-[-6px] font-bold hover:duration-500 hover:bg-[#fff] hover:text-[#317773] border-2 border-[#317773]"
              />
            </Link>
          </ul>
          {/* <a
