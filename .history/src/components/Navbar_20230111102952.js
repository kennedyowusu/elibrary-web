...
const Navbar = () => {
  ...
  return (
    <nav className="shadow-md w-full fixed top-0 left-0">
      <div className="md:flex items-center justify-between bg-white py-4 md:py-5 px-5">
        <div className="font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-gray-800 bg-red-900">
          ...
          {' '}
          <div
            className="flex justify-end md:hidden lg:hidden cursor-pointer text-2xl text-gray-800 hover:text-[#317773] hover:duration-500 m-auto"
          >
            <HiBars3 className="w-10" />
          </div>
        </div>
