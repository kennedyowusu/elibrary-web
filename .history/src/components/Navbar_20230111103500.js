    ...
    <nav className='shadow-md w-full fixed top-0 left-0'>
      <div className='md:flex items-center justify-between bg-white py-4 md:py-5 md:px-14'>
        <div className='font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-gray-800 bg-red-900'>
          <img src={Logo} alt='Logo' className='w-10 h-10 ml-2 mr-3 px-14' />
          <span className='text-[#317773]'>Edu</span> Library{' '}
          <div className='flex justify-end items-center md:hidden lg:hidden cursor-pointer text-2xl text-gray-800 hover:text-[#317773] hover:duration-500'>
