 ...
 return (
   <footer className='w-full bg-[#317773] text-white flex justify-between shadow-md fixed py-4 md:py-5 md:px-14 bottom-0 left-0'>
     ...
     <div className='flex flex-col space-y-4'>
       <Link to='/about'>
         <h1 className='text-l pb-3'>About Us</h1>
       </Link>
       <Link to='/about'>
         <h1 className='text-l pb-3'>Responsibilities</h1>
       </Link>
       <Link to='/about'>
         <h1 className='text-l pb-3'>Our Services </h1>
       </Link>
       <Link to='/about'>
         <h1 className='text-l pb-3'>Contact Us</h1>
       </Link>
       <Link to='/about'>
         <h1 className='text-l pb-3'>About Us</h1>
       </Link>
