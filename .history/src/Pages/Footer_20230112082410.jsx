...
const Footer = () => {
 return (
   <footer className='w-full bg-[#317773] text-white flex justify-between shadow-md fixed py-4 md:py-5 md:px-14 bottom-0 left-0'>
    ...
    <NavLink
      to='/about'
    >About Us</NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink></NavLink>
     </div>
