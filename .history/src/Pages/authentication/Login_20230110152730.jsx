    ...
    <section className='bg-gray-50 min-h-screen flex items-center justify-center'>
      ...
      <div className='bg-gray-100 flex rounded-xl shadow-lg max-w-3xl p-5'>
        ...
        <div className='sm:w-1/2 px-8'>
          ...
          <div className='mt-10 grid grid-cols-3 items-'>
            <hr className='text-sm mt-10 grid grid-cols-3 items-center text-gray-500' />
            <p>Or</p>
            <hr className='text-sm grid grid-cols-3 items-center text-gray-500' />
          </div>
