              ...
              <form action='' method='post' className='flex flex-col space-y-4'>
                ...
                <div>
                  <input
                    ...
                    name='name'
                    id='name'
                    className='w-full border-2 border-gray-200 rounded-xl p-2 focus:outline-none focus:border-teal-500'
                ...
                <div>
                  <input type="text" name="name" id="name" className='w-full border-2 border-gray-200 rounded-xl p-2 focus:outline-none focus:border-teal-500' placeholder='Full Name' />
                </div>
              </form>
            </div>
          </div>
