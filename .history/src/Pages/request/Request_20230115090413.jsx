          ...
          <div>
            <div className='bg-white rounded-xl shadow-lg p-8'>
              <form action="" method="post" className='flex flex-col space-y-4'>
                <div>
                  <label htmlFor="name" className='text-sm font-bold text0'>
                    Full Name
                  </label>
                </div>
                <div>
                  <input type="text" name="name" id="name" className='w-full border-2 border-gray-200 rounded-xl p-2 focus:outline-none focus:border-teal-500' />
                </div>
              </form>
