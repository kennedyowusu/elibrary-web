...
const RequestedBooks = () => {
  return (
    <section>
      <article className='bg-gray-800 text-gray-200 mx-auto flex flex-wrap mb-8 mt-24 flex-row'>
        <Link to=''>
          <img
            src={RequestedBooksImage}
            alt='Rich Dad Poor Dad'
            // style={{ width: '20%', height: '20%' }}
       className=' mt-5 flex justify-center items-baseline
            w-full h-full object-cover object-center rounded-lg shadow-md sm:w-full sm:h-full bg-red-500'
          />
        </Link>
