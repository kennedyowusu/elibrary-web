   ...
   <footer className='w-full bg-[#317773] text-white flex justify-between shadow-md fixed py-4 md:py-5 md:px-14 bottom-0 left-0'>
     <div className='flex flex-col justify-center items-center'>
       ...
       <p>
         ...
         <address>
           <p className='text-l font-bold text-center'>West Legon Accra, Ghana Concord Royal Plaza</p>
           <a href='tel:+233 24 000 0000'>+233 24 000 0000</a> </<AppBar position="fixed" color="primary">
             <Toolbar>
