...
const Details = () => {
  return (
    <section className='w-screen mt-28 mb-8 grid grid-cols-1 md:grid-cols-2 container mx-auto px-20'>
     ...
     <button className="
        bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mt-10 md:mt-0 md:ml-10 mb-10 md:mb-0
     ">
          <a href='https://www.amazon.com/Rich-Dad-Poor-Teach-Middle/dp/1612680196'> Buy Now</a>
       </button>
      </div>
    </section>
  )
