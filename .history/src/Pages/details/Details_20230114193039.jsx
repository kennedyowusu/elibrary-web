...
const Details = () => {
 return (
   <section className='w-screen h-[70vh] mt-28 grid grid-cols-1 md:grid-cols-2 container mx-auto px-20 bg-red-500'>
     {/* Divide page into two */}
     <div className='w-full h-full bg-green-500 flex items-start justify-start'>
