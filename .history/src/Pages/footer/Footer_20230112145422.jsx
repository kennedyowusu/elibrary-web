    ...
    <footer className='bg-gray-900 text-white'>
      <div className='md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] py-4'>
        <h1
          ...
          md:w-2/5 '
        >
          <span className='text-teal-400 ml-9'>Free</span> for all students and staff
        </h1>
        <div>
          <input
            type='text'
            ...
            sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded px-2 focus:outline-none focus:<AppBar position="fixed" color="primary">
              <Toolbar>
