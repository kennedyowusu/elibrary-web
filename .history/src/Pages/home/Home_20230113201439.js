      ...
      <div className='flex items-center justify-center min-h-screen container mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
          ...
          <div className='rounded-xl shadow-lg'>
            <div className='p-5 flex flex-col'>
              ...
              <div className='py-5 px-6 sm:px-8'>
                ...
                <button className='bg-teal-400 hover:bg-teal-500 text-white font-bold py-2 px-4 rounded mt-4 w-full'>
                  View Details
                </button>
              </div>
            </div>
          ...
          <div className='rounded-xl shadow-lg'>
            <div className='p-5 flex flex-col'>
              <div className='rounded-xl overflow-hidden'>
                <img src='https://images.pexels.com/photos/1832959/pexels-photo-1832959.jpeg?auto=compress&cs=tinysrgb&crop=faces&fit=crop&h=200&w=200' alt='Web Design' className='w-full h-40 sm:h-48 object-cover' />
              </div>
              <div className='py-5 px-6 sm:px-8'> 
                <h2 className='text-xl sm:text-2xl text-gray-800 font-semibold mb-3'>
                  Web Design
