        ...
        return (
          <div className='p-5 flex flex-col'>
            <div className='rounded-xl overflow-hidden'>
              <img src={item.img} alt={item.alt} className='w-full h-40 sm:h-48 object-cover' />
            </div>
            <div className='py-5 px-6 sm:px-8'>
              <h2 className='text-xl sm:text-2xl text-gray-800 font-semibold mb-3'>{item.title}</h2>
