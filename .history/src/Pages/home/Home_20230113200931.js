            ...
            <div className="p-5 flex flex-col">
              ...
              <div className="py-5 px-6 sm:px-8">
                ...
                <ul className="flex mt-8">
                  <li>
                    <img src="https://images.pexels.com/photos/1758845/pexels-photo-1758845.jpeg?auto=compress&cs=tinysrgb&crop=faces&fit=crop&h=200&w=200" alt="Face" className="rounded-full w-10 h-10 object-cover border-2 border-white" />
                  </li>
              </div>
              </div>
