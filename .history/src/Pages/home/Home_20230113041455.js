  ...
  <>
    ...
    <section>
      <div class='min-h-screen sm:p-10 p-5 lg:px-10 bg-red-50'>
        <div class='min-h-screen max-w-5xl mx-auto place-content-center justify-center justify-items-center grid md:grid-cols-2 lg:grid-cols-3 gap-x-1 gap-y-5 bg-red-600'>
