          ...
          <div className='rounded-xl shadow-lg'>
            <div className="p-5 flex flex-col">
              <div className="rounded-xl overflow-hidden">
                <img src="https://images.pexels.com/photos/1758845/pexels-photo-1758845.jpeg?auto=compress&cs=tinysrgb&crop=faces&fit=crop&h=800&w=800" alt="Web Design" className="w-full h-40 sm:h-48 object-cover" />
              </div>
            </div>
