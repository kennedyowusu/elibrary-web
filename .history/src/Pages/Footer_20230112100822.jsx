      ...
      <footer className='w-full h-36 bg-[#317773] text-white flex justify-between shadow-md fixed py-4 md:py-5 md:px-14 bottom-0 left-0'>
        ...
        <div className='flex flex-col justify-between'>
          <div className='flex items-end '>
            ...
            <Link to='https://twitter.com/_iamkobby'>
       ...
       <Link to='https://www.instagram.com/_iamkobby/'>
              <FaInstagram className='mr-3' /></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link> </Link</Link></Link></Link></Link> </Link>>
